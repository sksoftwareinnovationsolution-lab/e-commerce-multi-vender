...
function FooterPromoBanner() {
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-[0_1_auto] items-center gap-7 lg:gap-14 max-[991px]:gap-6 max-[767px]:justify-center max-[767px]:gap-[22px] max-[639px]:gap-3">
        <div
          className="
    relative
  ...
  w-auto
  object-contain
  drop-shadow-[0_22px_34px_rgba(15,10,50,0.5)]
  lg:-translate-x-[136px]
"            src={giftImage}
            alt="Festive gift with surprise offers"
          />
        </div>

        <div className="flex shrink-0 items-center justify-center scale-[1.5] sm:scale-[2] lg:scale-[2.6]">          <img
