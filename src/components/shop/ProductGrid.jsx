...
const placeholderProducts = Array.from({ length: 24 }, (_, i) => i + 1);

function ProductGrid({ onOpenSidebar }) {
    ...
    <section className="pgrid">
      <div className="pgrid__toolbar">
        <div className="pgrid__toolbar-left">
          ...
          <span className="pgrid__showing">Showing 1–24 of 196 products</span>
        </div>
